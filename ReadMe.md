...
Enable LLMs to call external tools via Model Context Protocol. See [**MCP Documentation →**](docs/mcp_tool_calling.md)

```bash
# Start with single MCP server
...
# Or with config file for multiple servers
