...
pub struct Sequence {
    ...
    /// Session ID generated for tool call continuation (set by scheduler when tool call detected)
    pub tool_call_session_id: Option<String>,
}
