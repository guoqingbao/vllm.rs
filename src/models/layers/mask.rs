...
#[cfg(any(feature = "flash-attn", feature = "flash-context"))] // If flash-attn or metal is enabled, we don't implement this function.
...
#[cfg(not(any(feature = "flash-attn", feature = "flash-context")))]
